...
if __name__ == "__main__":
    ...
    if (args.dataset == 'tiny_imagenet'):
        ...
        traindir = os.path.join(args.dataset_root, 'train')
        valdir = os.path.join(args.dataset_root, 'val')
        ...
        ori_val_dataset = torchvision.datasets.ImageFolder(
            valdir,
            torchvision.transforms.Compose([
        ...
        indices = list(range(num_ori_val))
        split = int(np.floor(0.5 * num_ori_val))
